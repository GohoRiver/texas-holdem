window.PokerStorage = (function(){
  ...
  function setPracticeChips(v){ safeSet(PRACTICE_CHIPS_KEY, String(Math.max(0, Math.floor(v)))); }
  function addPracticeChips(v){ setPracticeChips(getPracticeChips() + Math.max(0, Math.floor(v))); }
